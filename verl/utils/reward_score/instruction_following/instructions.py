...
from verl.utils.reward_score.instruction_following import instructions_util
...
class ResponseLanguageChecker(Instruction):
    ...
    def check_following(self, value):
        ...
        try:
            ...
            _logger.error("Unable to detect language for text %s due to %s", value, e)  # refex: disable=pytotw.037
            return True
