...
import os
from examples.skillrl.agent_system.environments.prompts import *
from examples.skillrl.agent_system.environments.base import EnvironmentManagerBase, to_numpy
from examples.skillrl.agent_system.memory import SimpleMemory, SearchMemory
...
class SearchEnvironmentManager(EnvironmentManagerBase):
    ...
    def __init__(self, envs, projection_f, config):
        ...
        if config.env.get('use_skills_only_memory', False):
            from examples.skillrl.agent_system.memory import SkillsOnlyMemory
            ...
            from examples.skillrl.agent_system.memory import RetrievalMemory
...
def make_envs(config):
    ...
    if "search" in config.env.env_name.lower():
        from examples.skillrl.agent_system.environments.env_package.search import build_search_envs, search_projection
        ...
        from examples.skillrl.agent_system.environments.env_package.gym_cards import build_gymcards_envs, gym_projection
        ...
        from examples.skillrl.agent_system.environments.env_package.alfworld import build_alfworld_envs, alfworld_projection
        ...
        from examples.skillrl.agent_system.environments.env_package.sokoban import build_sokoban_envs, sokoban_projection
        env_kwargs = {
        ...
        from examples.skillrl.agent_system.environments.env_package.webshop import build_webshop_envs, webshop_projection
        ...
        from examples.skillrl.agent_system.environments.env_package.appworld import build_appworld_envs, appworld_projection
